...
if __name__ == '__main__':
    ...
    cl = Client(args,
                ...
                send_slow=None)
    prompt = "hello world"
    cl.preprare_local_dataset(0)
    result = cl.tokenize(prompt)
    prompt_first = args.prompter.generate_prompt(cl.local_train_dataset["instruction"][0],cl.local_train_dataset["context"][0],cl.local_train_dataset["response"][0])
    print("prompt: \n{}".format(prompt_first))
    # print("prompt: {}".format(cl.local_train_dataset["instruction"][0]))
    print("input_ids: {}".format(cl.local_train_dataset["input_ids"][0]))
    print("attention_mask: {}".format(cl.local_train_dataset["attention_mask"][0]))
    print("labels: {}".format(cl.local_train_dataset["labels"][0]))
    # print(result)
